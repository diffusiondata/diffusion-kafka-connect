...
/**
 * Converter for translating between CBOR-Encoded {@link JSON} objects and
 * Kafka-compatible value/schema pairs.
 */
public class JSONToSchemaValue {
     ...
     * <p>
     * The returned schema may be null if an appropriate schema cannot be
     * inferred. This is most likely in Arrays or Maps with mixed value types.
     * Primitive values will be associated with the closest matching Schema; for
     * Integers, this will either be {@link Schema#INT32_SCHEMA} or
     * {@link Schema#INT64_SCHEMA}, while floating point values will be returned
     * as {@link Schema#FLOAT64_SCHEMA}.
     * <p>
     * This method assumes that the provided JSON encapsulates a well-formed
     * CBOR backing array. Since this is used to translate data directly from
     * Diffusion, which can perform its own input validation, it is encumbent on
     * the user to ensure that values are able to be parsed correctly. Any
     * parsing errors will result in a {@link DataException} being thrown.
     *
        ...
        switch (parser.currentToken()) {
            ...
            default:
                throw new DataException(
                    "Unknown CBOR Token: " + parser.currentToken());
        }
    }
}
