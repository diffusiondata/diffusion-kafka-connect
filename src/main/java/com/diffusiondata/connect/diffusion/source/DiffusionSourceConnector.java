...
public class DiffusionSourceConnector extends SourceConnector {
    ...
    public List<Map<String, String>> taskConfigs(int maxTasks) {
         ...
         * the Connect framework expects. Since Diffusion operates under
         * last-write-wins, there is no way for tasks receiving messages
         * across multiple partitions to guarantee correct ordering
         */
        return asList(props);
    }
