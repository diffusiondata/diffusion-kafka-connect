...
import static com.pushtechnology.connect.diffusion.data.RecordToJSON.JSON_TYPE;
...
public class JSONToSchemaValueTest {
	...
	public void testPrimitives() throws Exception {
		...
		assertSchemaAndValue(Schema.STRING_SCHEMA, "hello world", "\"hello world\"");
	}
	...
	public void testMixedArray() throws Exception {
		assertSchemaAndValue(null, asList(4, "hello world", true), "[4,\"hello world\",true]");
	}

	@Test
	public void testNestedArray() throws Exception {
		final Schema schema = array(type(ARRAY).build()).build();
		assertSchemaAndValue(schema, asList(asList(1, 2, 3), asList(4, 5, 6)), "[[1,2,3],[4,5,6]]");
	}
	...
	public void testObject() throws Exception {
		...
		assertSchemaAndValue(null, map, "{\"foo\":\"hello world\",\"bar\":123,\"baz\":[4,5,6]}");
	}
	...
	public void testNestedObject() throws Exception {
		...
		assertSchemaAndValue(null, map2, "{\"foo\":{\"foo\":\"hello world\",\"bar\":123,\"baz\":[4,5,6]}}");
	}
